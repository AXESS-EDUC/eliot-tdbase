...
/**
 * Représente les résultats d'un élève pour un Service et une Période
 *
 * Résultat est supprimé en cascade quand la période proprietaire est supprimé.
 *
 * @author bper
 */
class ResultatEleveServicePeriode implements Serializable {
  ...
  boolean equals(Object o) {
    if (o instanceof ResultatEleveServicePeriode) {
      ResultatEleveServicePeriode res = (ResultatEleveServicePeriode) o
