 ...
 * @author John Tranier
 */
class CompetenceImporterSpec extends UnitSpec {
  ...
  def "testImporteCompetence"() {
    ...
    Domaine domaine = new Domaine(referentiel: referentiel)

    String competenceNom = "nom"
    String competenceDescription = "description"
