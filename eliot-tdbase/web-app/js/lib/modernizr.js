 ...
 * Build: http://www.modernizr.com/download/#-geolocation-inlinesvg-smil-svg-svgclippaths-touch-webgl-iepp-cssclasses-teststyles-prefixes-load
 */
;
window.Modernizr = function (a, b, c) {
    ...
    var d = "2.0.6", e = {}, f = !0, g = b.documentElement, h = b.head || b.getElementsByTagName("head")[0], i = "modernizr", j = b.createElement(i), k = j.style, l, m = Object.prototype.toString, n = " -webkit- -moz- -o- -ms- -khtml- ".split(" "), o = {svg:"http://www.w3.org/2000/svg"}, p = {}, q = {}, r = {}, s = [], t = function (a, c, d, e) {
    ...
    p.webgl = function () {
        ...
        return!!b.createElementNS && /SVG/.test(m.call(b.createElementNS(o.svg, "animate")))
    }, p.svgclippaths = function () {
        return!!b.createElementNS && /SVG/.test(m.call(b.createElementNS(o.svg, "clipPath")))
    };
    for (var C in p)w(p, C) && (u = C.toLowerCase(), e[u] = p[C](), s.push((e[u] ? "" : "no-") + u));
    ...
    }(a, b), e._version = d, e._prefixes = n, e.testStyles = t, g.className = g.className.replace(/\bno-js\b/, "") + (f ? " js " + s.join(" ") : "");
    return e
