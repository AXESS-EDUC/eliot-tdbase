<%@ page import="org.lilie.services.eliot.tdbase.securite.SecuriteSessionService; org.lilie.services.eliot.tdbase.RoleApplicatif; org.lilie.services.eliot.tice.scolarite.FonctionEnum; org.lilie.services.eliot.tdbase.QuestionTypeEnum" %>
%{--
...
<et:container class="container">
  ...
  <div class="portal-menu">
    ...
    <g:render template="/roleApplicatifSelection" model="[authority: RoleApplicatif.ELEVE.authority,securiteSessionServiceProxy:securiteSessionServiceProxy]"/>
