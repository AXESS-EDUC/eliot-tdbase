...
<%@ page import="org.lilie.services.eliot.tdbase.ReponseAttachement" %>


<g:if test="${specifobject?.reponseAttachementId}">
...
<g:else>
  <input type="file" name="reponsesCopie.listeReponses[${indexReponse}].specificationObject.fichier">
</g:else>
