...
<tr>
  <td class="label">
    <g:message code="question.label.reponse" />(s)<span class="obligatoire">*</span>&nbsp;:
  </td>
  <td>
    <table>
      <tr>
        <td id="specifobject_reponses">
          <g:render template="/question/BooleanMatch/BooleanMatchEditionReponses"
...
<tr>
  <td class="label">
    <g:message code="question.label.complement_reponses" />&nbsp;:
  </td>
  <td>
     <g:textArea
