...
<g:if test="${question.estVerrouille()}">

  |

  <g:if test="${question.estVerrouilleParMoi(utilisateur)}">
  ...
  <g:else>
    <span class="locked">En cours de modification par ${question.auteurVerrou.nomAffichage}</span>
  </g:else>
</g:if>