...
class Discussion {
  ...
  static constraints = {
    libelle(maxSize: 200)
    itemCible(nullable: false)
  }

  static belongsTo = [itemCible: DomainItem]

  static mapping = {
    table('forum.discussion')
    id column: 'id', generator: 'sequence', params: [sequence: 'forum.discussion_id_seq']
