 ...
 */
class ReponseSliderSpecificationService extends ReponseSpecificationService<ReponseSliderSpecification> {

  @Override
  ReponseSliderSpecification createSpecification(Map map) {
    new ReponseSliderSpecification(map)
  }

  @Override
  ReponseSliderSpecification getObjectInitialiseFromSpecification(QuestionSpecification questionSpecification) {
 ...
 */
class ReponseSliderSpecification implements ReponseSpecification {
