...
class NotificationOnPublicationResultats extends AbstractNotification {
    ...
    left outer join td.preference_personne as preference on (profil.personne_id = preference.personne_id and preference.notification_on_publication_resultats = true)
