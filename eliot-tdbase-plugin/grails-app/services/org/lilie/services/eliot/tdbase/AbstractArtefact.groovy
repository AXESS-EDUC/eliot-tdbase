 ...
 * @author John Tranier
 */
abstract class AbstractArtefact implements Artefact {

  @Override
  boolean estVerrouille() {
    refresh() // le cache Hibernate n'est pas nécessairement à jour
    ...
    return auteurVerrou && dateVerrou && dateVerrou > dateLimitVerrou
  }
